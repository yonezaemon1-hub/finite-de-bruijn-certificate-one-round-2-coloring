...
\date{September 9, 2026\\\small Preprint draft --- not peer reviewed}
...
\paragraph{Artifact availability in this proofreading draft.}
The certificate files listed below are distributed with this manuscript in
\texttt{Yonezu\_Paper11\_Proofreading\_Bundle\_v0.5.zip}.  A permanent
public GitHub repository and Zenodo software DOI have not yet been assigned;
those identifiers are a required prepublication item and will replace this
draft-local locator before public release.  No public URL or DOI is fabricated
